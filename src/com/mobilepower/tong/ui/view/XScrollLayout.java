...
public class XScrollLayout extends ViewGroup {
	...
	public XScrollLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public XScrollLayout(Context context, AttributeSet attrs, int defStyle) {
